...
class Student implements Cloneable
{
	...
	public  Student(int rollNo, String name, double percentage) // default access modifier if not mentioned
	{
		this.rollNo=rollNo;
		this.name=name;
	...
	// if we want to create a object through clone() method then 
